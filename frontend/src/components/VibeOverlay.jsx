...
import { ChevronDown, Sparkles, CloudRain, Flame, Zap, Wind, Play, Pause, SkipBack, SkipForward, Repeat, Shuffle, Star, MoreHorizontal } from 'lucide-react';
    ...
    return (
        <div className={`vibe-overlay ${activeVibe.id}`}>
            ...
            <div className="vibe-content">
                    ...
                    <div className="w-full max-w-[400px] mb-8">
                        <div className="flex justify-between items-end mb-4">
                            ...
                            <div className="flex gap-4 items-center mb-1">
                                ...
                                <button className="text-white/50 hover:text-white transition-colors" title="更多">
                ...
                <div className="vibe-lyrics-container" ref={containerRef}>
                    {isFetching ? (
